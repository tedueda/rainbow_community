...
def upgrade():
    ...
    op.drop_index(op.f('idx_follows_followee'), table_name='follows')
    op.drop_index(op.f('idx_follows_follower'), table_name='follows')
    op.drop_index(op.f('idx_media_assets_user'), table_name='media_assets')
    op.drop_index(op.f('idx_notifications_user_read_created'), table_name='notifications')
    op.drop_index(op.f('idx_point_events_user'), table_name='point_events')
    ...
    op.drop_index(op.f('idx_posts_user_created'), table_name='posts')
    ...
    op.drop_index(op.f('idx_reactions_target'), table_name='reactions')
    ...
    op.drop_index(op.f('users_email_unique_lower'), table_name='users')
