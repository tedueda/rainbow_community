...
set -gx VIRTUAL_ENV /Users/tedueda/Desktop/LGBTQ/LGBTQ_Community2/rainbow_community-7/backend/.venv
...
if test -n app-py3.12
    set -gx VIRTUAL_ENV_PROMPT app-py3.12
else
