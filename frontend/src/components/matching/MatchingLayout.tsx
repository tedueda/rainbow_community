  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="flex gap-3 mb-6">
        ...
        <NavLink to="/matching/likes" className={({ isActive }) => `px-3 py-2 rounded-md text-sm ${isActive ? 'bg-pink-100 text-pink-700' : 'text-gray-600 hover:bg-gray-100'}`}>タイプ</NavLink>
